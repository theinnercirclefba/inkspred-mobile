 ...
 * oxblood, the client's left in ink. A message carrying a quote renders the
 * artist QuoteCard instead of a plain bubble; attachments render as honest
 * "photo — view on web" chips since signing the private references bucket needs
 * the service role (web-only phase). Mirrors the customer MessageBubble so a
 * thread reads the same on both surfaces.
 */
